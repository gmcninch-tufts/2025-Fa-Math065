...
template](/course-assets/latex-examples/latex-template.tex) for
homework assignments that you can start with. I've also include the
content of this template in this post -- see below.
...
[Here is the `PDF` obtained from compiling this `latex`
document](/course-assets/latex-examples/latex-template.pdf).

And here is the content of this template:
